...
from migration.config import KG_90, get_groq_run_paths
...
GROQ_PATHS = get_groq_run_paths(KG_90)
IN_PATH = GROQ_PATHS["input"]
OUT_PATH = GROQ_PATHS["output"]
INCOMPLETE_OUT_PATH = GROQ_PATHS["incomplete"]
CSV_OUT_PATH = GROQ_PATHS["csv"]
