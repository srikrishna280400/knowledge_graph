...
from backend.app.run_groq_all import RESPONSE_FORMAT
import csv
...
IN_PATH = Path(__file__).resolve().parents[1] / "data" / "groq_batch_x.jsonl"
OUT_PATH = Path(__file__).resolve().parents[1] / "data" / "groq_batch_x_outputs.jsonl"
INCOMPLETE_OUT_PATH = OUT_PATH.with_name(OUT_PATH.stem + "groq_batch_x_incomplete.jsonl")
