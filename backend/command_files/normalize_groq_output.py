...
def stable_concept_node_id(concept_type: str, concept_name: str) -> str:
...
def extract_concepts_from_cognitive_map(cognitive_map: dict) -> list[dict]:
...
def main():
    in_path = Path(r"data/groq_batch_20r_outputs.jsonl")     # change every batch
